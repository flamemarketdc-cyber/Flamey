...
export const GitBranchIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><line x1="6" y1="3" x2="6" y2="15"></line><circle cx="18" cy="6" r="3"></circle><circle cx="6" cy="18" r="3"></circle><path d="M18 9a9 9 0 0 1-9 9"></path></svg>
);
...
export const KeyIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}><circle cx="7.5" cy="15.5" r="5.5"></circle><path d="m21 2-9.6 9.6"></path><path d="m15.5 7.5 3 3L22 7l-3-3"></path></svg>
);
...
export const CornerUpLeftIcon = (props: IconProps) => (
...
export const GamepadIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M17.5 22a2.5 2.5 0 0 0-2.5-2.5h-5A2.5 2.5 0 0 0 7.5 22" />
    <path d="M14 13.5V11a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v2.5" />
    <path d="M6 11.5c0-1.5 3-2.5 6-2.5s6 1 6 2.5" />
  </svg>
);
...
export const SwooshIcon = (props: IconProps) => (
    <svg viewBox="0 0 276 33" fill="none" xmlns="http://www.w3.org/2000/svg" {...props} preserveAspectRatio="none">
    <path d="M1.5 28C70 5, 200 5, 274.5 22" stroke="url(#paint0_linear_swoosh)" strokeWidth="3" strokeLinecap="round"/>
    <defs>
      <linearGradient id="paint0_linear_swoosh" x1="0" y1="23" x2="276" y2="23" gradientUnits="userSpaceOnUse">
        <stop stopColor="#00B4FF"/>
        <stop offset="1" stopColor="#33C7FF"/>
      </linearGradient>
    </defs>
  </svg>
);